function [fitresult, resnorm, exitflag] = PARA_SIM_GAUSS2DFIT(Xgrid,Ygrid,Zgrid)
...
% [fitresult, resnorm, exitflag] = PARA_SIM_GAUSS2DFIT(cell_PSF_xyI)

%% Zuhui Wang
%% 2020/11/15
%% Convert individual PSF xyI stored in cell_PSF into matrix
% [Xgrid,Ygrid,Zgrid] = cellfun(@ARRAY2GRID,cell_PSF_xyI,'UniformOutput',false);

% % Fill the gap to match maxSz size
% [Xgrid,Ygrid,Zgrid] = GRID_REGULARIZATION(Xgrid,Ygrid,Zgrid);
